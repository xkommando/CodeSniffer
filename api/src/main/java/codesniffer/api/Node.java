...
public abstract class Node {
    ...
    public void setOrphanComments(List<Comment> orphanComments) {
        ...
        setAsParentNodeOf(orphanComments);
    }
...
//    }
    ...
    public List<Comment> getAllContainedComments() {
        ...
        List<Comment> comments = new ArrayList<>(16);

        List<Comment> orfs = getOrphanComments();
        if (orfs != null)
    ...
    public void setParentNode(Node parentNode) {
        ...
        if (this.parentNode != null && this.parentNode.childrenNodes != null)
