...
public class EnumDeclarationContextAdapter implements Adapter<EnumDeclaration, Java8Parser.EnumDeclarationContext> {
    public EnumDeclaration adapt(Java8Parser.EnumDeclarationContext context, AdapterParameters adapterParameters) {
